...
def load_best_pca_data(n_train):
    ...
    csv_path = os.path.join(script_dir, '..', '..', 'analysis_v3_phonon_dielectric_mp', f'n{n_train}', 'data', 'best_pca_per_property.csv')
...
def main():
    ...
    # Expected: 3 models × 3 properties × 3 n_train = 27 rows (note: dgp missing n500)
    expected_rows = 3 * 3 * 3
