...
def plot_bar_chart_per_property(best_configs_df, property_name, metric='R2',
    ...
    for i, model in enumerate(models):
        ...
        # Skip if no valid data for this model (e.g., DGP for n=100, n=250)
    ...
    # Set title
    title = f'{property_name}: {metric}\n(n=250, Best PCA per Surrogate for This Property)'
    ...
    # Save figure
    output_path = os.path.join(output_dir, f'{property_name}_{metric}_n250.png')
    plt.savefig(output_path, dpi=300, bbox_inches='tight')
    print(f"    Saved: {property_name}_{metric}_n250.png")
