...
# Creates /scratch/user/u.sa119259/envs/ase-test with all featurizers for ASE regression tests.
# Run inside tmux on an ACES login/build node.
# Usage: bash setup_ase_test_env.sh 2>&1 | tee /scratch/user/u.sa119259/ase_test_install.log
...
ENVDIR="/scratch/user/u.sa119259/envs/ase-test"
echo "============================================================"
...
echo ""
echo "--- [1/9] PyTorch 2.5.1 + CUDA 12.4 ---"
pip install torch==2.5.1 torchvision==0.20.1 \
    --index-url https://download.pytorch.org/whl/cu124

echo ""
echo "--- [2/9] torch-geometric ecosystem (for FAIRChem) ---"
pip install torch-scatter torch-sparse torch-cluster \
    -f https://data.pyg.org/whl/torch-2.5.1+cu124.html
pip install torch-geometric

echo ""
echo "--- [3/9] BoTorch / GPyTorch / linear_operator ---"
pip install botorch gpytorch linear_operator

echo ""
echo "--- [4/9] DScribe (SOAP) ---"
pip install dscribe
...
echo ""
echo "--- [7/9] FAIRChem (UMA / eSEN) ---"
pip install fairchem-core

echo ""
echo "--- [8/9] Materials science + scientific Python stack ---"
pip install matminer pymatgen ase spglib
pip install numpy scipy pandas matplotlib scikit-learn seaborn tqdm

echo ""
echo "--- [9/9] Materials Project API (for data-prep) ---"
pip install mp-api
...
echo "  source activate /scratch/user/u.sa119259/envs/ase-test"
