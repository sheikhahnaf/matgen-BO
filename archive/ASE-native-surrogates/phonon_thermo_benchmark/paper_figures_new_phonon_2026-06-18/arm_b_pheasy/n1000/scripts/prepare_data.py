"""
Phase 0: Data Preparation for Simplified ASE Regression Analysis (n=1000 only)

This script:
1. Loads aggregated results from previous analysis
2. Filters to n=1000 only
...
def load_and_filter_data():
    ...
    # Filter to n=1000
    df = df[df['n_train'] == 1000].copy()
    print(f"\nAfter filtering to n=1000: {df.shape}")
...
def save_filtered_data(df):
    ...
    output_path = os.path.join(output_dir, 'filtered_n1000.csv')
