...
DATASETS = {
    ...
    "phonon": {
        "data_dir": ANALYSIS_ROOT / "analysis_v3_phonon_dielectric_mp" / "n500" / "data",
        "title": "Phonon properties",
        "heatmap_out": FIG_DIR / "fig_heatmap_phonon_R2_n500.pdf",
        "pca_out": FIG_DIR / "fig_pca_phonon_R2_n500.pdf",
    },
}
