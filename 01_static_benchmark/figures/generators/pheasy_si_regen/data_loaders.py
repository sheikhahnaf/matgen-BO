...
# PHEASY-SI variant: the "phonon" slot points at the large Pheasy phonon-thermo dataset
# (11,818 materials) WITH DGP, rebuilt under 01_static_benchmark/data/arm_b_pheasy_full/.
PHEASY_FULL = _ROOT / "01_static_benchmark" / "data" / "arm_b_pheasy_full"
...
DATASET_LABEL = {
    ...
    "phonon": "Phonon thermodynamics — Pheasy (11,818 materials, 4 properties)",
}
