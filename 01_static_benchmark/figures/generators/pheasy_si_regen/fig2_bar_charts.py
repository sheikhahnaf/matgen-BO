...
FIGURES_DIR = Path(__file__).resolve().parent / "out_pheasy"

# PHEASY-SI: only the big Pheasy phonon dataset (the "phonon" slot is repointed in data_loaders).
DATASETS = [
    ("phonon", "fig2_bar_pheasy_R2_grouped.png"),
]
