...
# Per-descriptor reduction search space (matching notebook main functions exactly)
DESCRIPTOR_REDUCTIONS = {
    'soap':  [-45, -40, -35, -30, -20, -10, 0],
    'mace':  [-45, -40, -35, -30, -20, -10, 0],
    'orb':   [-45, -40, -35, -30, -20, -10, 0],
    'uma':   [-45, -40, -35, -30, -20, -10, 0],
}
